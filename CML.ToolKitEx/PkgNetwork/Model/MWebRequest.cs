...
namespace CML.PkgNetwork
{
    ...
    public class MWebRequest
    {
        ...
        /// 代理（默认不开启）
        /// </summary>
        public MProxy Proxy { get; set; } = new MProxy();
        /// <summary>
        /// 超时时间（毫秒，默认1000毫秒）
        /// </summary>
        ...
        /// 上传限速
        /// </summary>
        public MTransSpeed UploadSpeed { get; set; } = new MTransSpeed();
        /// <summary>
        /// 下载限速
        /// </summary>
        public MTransSpeed DownloadSpeed { get; set; } = new MTransSpeed();
